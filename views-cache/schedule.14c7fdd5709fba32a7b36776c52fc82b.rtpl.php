...
<!-- Moment -->
<script src="res/site/js/components/moment/moment.min.js"></script>

<!-- Full Calendar -->
<link href="res/site/js/components/fullcalendar-3.9.0/fullcalendar.min.css" rel="stylesheet"></link>
<script src="res/site/js/components/fullcalendar-3.9.0/fullcalendar.js"></script>

<!-- DateTimePicker -->
<script src="res/site/js/components/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<link href="res/site/js/components/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet"></link>
