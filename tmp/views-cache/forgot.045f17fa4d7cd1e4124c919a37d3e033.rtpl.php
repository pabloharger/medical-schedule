<?php if(!class_exists('Rain\Tpl')){exit;}?><div class="py-2">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          <div class="card-header"> <?php echo L('interface_label_forgotPassword'); ?><br></div>
            <?php if( $error !== '' ){ ?>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <form action="/account/forgot" method="POST" data-js="login-form-main">
                    ...
                    <button class="btn btn-success" data-js="login-btn-send"><?php echo L('interface_button_send'); ?> <br></button>
